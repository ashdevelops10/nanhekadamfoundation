        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-4">
              Empowering underprivileged children through education, nutrition, and community
              development. Every small step leads to a giant leap.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5 text-sm text-white/70">
                ...
                <span>123 Community Lane, New Delhi, India 110001</span>
              </li>
              <li className="flex items-center gap-2.5 text-sm text-white/70">
                <Mail size={16} className="shrink-0" />
                <a href="mailto:info@nanhekadamfoundation.org" className="hover:text-white transition-colors">
