            ...
            {programs.map((program, index) => (
              ...
              >
                <Link href={`/programs/${program.slug}`} className="block group h-full">
                  <div className="h-full bg-white border border-gray-100 rounded-2xl p-6 md:p-8 hover:shadow-lg transition-all hover:-translate-y-1">
                    ...
                    <h3 className="font-bold text-text text-xl mb-3 group-hover:text-primary transition-colors">
                      {program.title}
                    </h3>
