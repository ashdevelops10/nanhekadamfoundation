          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            >
              <div className="bg-gray-50 rounded-2xl p-6 md:p-8">
                <h2 className="text-2xl font-bold text-text mb-6">Choose Your Donation</h2>
                    ...
                    <button
                      ...
                      className={`py-3 rounded-xl font-semibold text-sm transition-all ${
                        selectedAmount === amount
                          ? "bg-primary text-white shadow-md"
                          : "bg-white border border-gray-200 text-text hover:border-primary"
                      }`}
                    >
                ...
                {/* Custom Amount */}
                <div className="mb-6">
                  <label htmlFor="custom-amount" className="block text-sm font-medium text-text mb-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary text-sm"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  <div>
                    <label htmlFor="donor-name" className="block text-sm font-medium text-text mb-1.5">Full Name</label>
                    <input
                      id="donor-name"
                      type="text"
                      className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary text-sm"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label htmlFor="donor-email" className="block text-sm font-medium text-text mb-1.5">Email</label>
                    <input
                      id="donor-email"
                      type="email"
                      className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary text-sm"
                ...
                <button className="w-full py-3.5 bg-accent hover:bg-accent-light text-white font-bold rounded-full transition-all hover:shadow-lg text-base flex items-center justify-center gap-2">
                  <Heart size={18} />
            ...
            >
              <h2 className="text-2xl font-bold text-text mb-6">Your Impact</h2>
              <div className="space-y-4">
                {impactCards.map((card, index) => (
                  ...
                  >
                    ...
                    <div>
                      <span className="font-bold text-primary text-sm">{card.amount}</span>
              ...
              <div className="mt-8 p-5 bg-warm rounded-2xl">
                <h3 className="font-bold text-text mb-3">Why Donate to Us?</h3>
